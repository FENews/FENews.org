...
<p style="text-align: center"><small>Code caching is split into cold, warm, and hot runs, using the in-memory cache on warm runs and the disk cache on hot runs.</small></p>
